...
- Run Gulp
  ...
  run `gulp` in your terminal to run gulp's default task. It will compile your resources, move them into a distribution folder, and serve them on localhost:3000
